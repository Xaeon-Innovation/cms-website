    ...
    <section className="bg-surface">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <motion.div 
          ...
          className="p-16 md:p-32 flex flex-col justify-center bg-surface-container-high border-r border-outline-variant/10 relative group"
        >
        ...
        <motion.div 
         ...
         className="p-16 md:p-32 flex flex-col justify-center bg-surface-container-lowest relative group"
        >
