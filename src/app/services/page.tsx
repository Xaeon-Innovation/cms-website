...
export default function ServicesPage() {
  ...
  return (
    <div className="bg-surface pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <motion.div 
          ...
          className="absolute -top-[10%] -right-[10%] w-[500px] h-[500px] rounded-full bg-primary/20 blur-[120px]"
        />
        <motion.div 
          animate={{ scale: [1, 1.5, 1], x: [0, -100, 0], opacity: [0.05, 0.1, 0.05] }}
          transition={{ duration: 20, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-[40%] -left-[10%] w-[600px] h-[600px] rounded-full bg-secondary/30 blur-[150px]"
        />
        <motion.div 
          animate={{ y: [0, -50, 0], opacity: [0.1, 0.15, 0.1] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
          className="absolute -bottom-[10%] right-[20%] w-[400px] h-[400px] rounded-full bg-primary-container/40 blur-[100px]"
        />
      </div>
      ...
      <div className="relative z-10">
            ...
            >
              ...
              <div className="lg:w-1/3">
                <div className="sticky top-32 space-y-6">
                  ...
                  <h2 className="text-4xl font-display text-primary tracking-tight">{category.title}</h2>
                  <p className="text-lg text-foreground/70 font-body leading-relaxed">{category.desc}</p>
                </div>
              </div>
        ...
        {/* CTA */}
        <section className="max-w-4xl mx-auto px-6 mt-40 text-center pb-20">
          <Magnetic intensity={0.1}>
            <motion.div 
              ...
              className="px-8 py-16 md:p-20 bg-surface-container-high shadow-2xl rounded-3xl space-y-8 border border-white/10 relative overflow-hidden group cursor-pointer"
            >
              ...
              <p className="text-foreground/80 relative z-10 max-w-xl mx-auto text-lg">
              ...
              <Link href="/contact" className="inline-block relative z-10 mt-6 pointer-events-auto">
                <Magnetic intensity={0.3}>
                  <Button variant="primary" size="lg" className="shadow-xl py-6 px-10 rounded-full text-lg group-hover:bg-primary-dark transition-all">
